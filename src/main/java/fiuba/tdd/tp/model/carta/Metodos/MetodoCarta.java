...
public abstract class  MetodoCarta {
    ...
    public abstract boolean esAplicableA(final Etapa etapa, final Zona zona, 
                                        Deque<Ejecucion> pilaMetodos, ArrayList<Carta> cartasUsadas, HashMap<Energia, Integer> energiaJugador);
